...
[View the project](https://gitther.github.io/harry-potter-character-search/#/)
...
1. Clone the repo
   ```sh
   git clone https://github.com/GitTher/harry-potter-character-search.git
   ```
...
Project Link: [https://github.com/GitTher/harry-potter-character-search](https://github.com/GitTher/harry-potter-character-search)
